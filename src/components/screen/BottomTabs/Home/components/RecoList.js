...
//import { HDFC } from '../../../../../assets/images';
import { CredCardView } from './CredCardView';
import { AdsView } from './AdsView';

export default function RecoList({navigation}) {
    const dataArray = [{
        ...
        CTA: 'Pay now',
        amount: '26,943',
        icon: <Image source={require('../../../../../assets/images/HDFC.png')}/>,
        adsView: false,
    },
    {
        ...
        CTA: 'Activate',
        amount: null,
        icon: <Image source={require('../../../../../assets/images/sbi.png')}/>,
        adsView: false,
    },
    {
    ...
    const headerComponent = () => {
        return (
            <View
                ...
                <Text style={{ color: Colors.whiteText, fontSize: 22, fontWeight: 'bold' }}>hello, Tanmay</Text>
               ...
               {/* <TouchableOpacity onPress={()=>navigation.navigate('DOB')}><Text style={{ color: Colors.greyText, fontSize: 12 }}>exit</Text></TouchableOpacity> */}
            </View>
        )
    }
